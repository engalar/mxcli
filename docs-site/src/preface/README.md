...
This documentation covers **mxcli**, a command-line tool for reading, querying, and modifying Mendix application projects, and **MDL (Mendix Definition Language)**, the SQL-like language it uses. Start with the [Vision](vision.md) to understand where this project is headed. The material is organized into ten parts:
