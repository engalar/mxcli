#!/bin/sh
# Guard: helpdesk-app.mdl and testdata/helpdesk-golden-11.6.6/ must always move together.
#
...
#   3. git add mdl-examples/use-cases/helpdesk/helpdesk-app.mdl testdata/helpdesk-golden-11.6.6/
#   4. git commit
