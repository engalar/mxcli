...
func findTestMPK(t *testing.T) string {
	...
	candidates := []string{
		...
		filepath.Join("..", "..", "..", "testdata", "helpdesk-golden-11.12.1", "widgets", "com.mendix.widget.web.Combobox.mpk"),
		filepath.Join("..", "..", "..", "testdata", "helpdesk-golden-11.6.6", "widgets", "com.mendix.widget.web.Combobox.mpk"),
		filepath.Join("..", "..", "..", "testdata", "helpdesk-clean-11.12.1", "widgets", "com.mendix.widget.web.Combobox.mpk"),
...
func findTestProjectDir(t *testing.T) string {
	...
	candidates := []string{
		...
		filepath.Join("..", "..", "..", "testdata", "helpdesk-golden-11.12.1"),
		filepath.Join("..", "..", "..", "testdata", "helpdesk-golden-11.6.6"),
		filepath.Join("..", "..", "..", "testdata", "helpdesk-clean-11.12.1"),
