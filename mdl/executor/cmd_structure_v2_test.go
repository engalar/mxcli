...
func TestExecShowStructureGen_Depth2_NonEmpty(t *testing.T) {
	...
	genCtx.Quiet = true
	if err := execShowStructureGenFn(genCtx, &ast.ShowStmt{ObjectType: ast.ShowStructure, Depth: 2}, genCtx.Deps); err != nil {
...
func TestExecShowStructureGen_Depth3_NonEmpty(t *testing.T) {
	...
	genCtx.Format = FormatTable
	genCtx.Quiet = true
	if err := execShowStructureGenFn(genCtx, &ast.ShowStmt{ObjectType: ast.ShowStructure, Depth: 3}, genCtx.Deps); err != nil {
...
func TestExecShowStructureGen_Depth1_DelegatesToLegacy(t *testing.T) {
	...
	ctx.Quiet = true
	if err := execShowStructureGenFn(ctx, &ast.ShowStmt{ObjectType: ast.ShowStructure, Depth: 1}, ctx.Deps); err != nil {
