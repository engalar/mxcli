...
func execContextFromDeps(deps *HandlerDeps) *ExecContext {
	return &ExecContext{
		...
		DomainModelReader:           deps.DomainModelReader,
		DomainModelWriter:           deps.DomainModelWriter,
		MicroflowWriter:             deps.MicroflowWriter,
		WorkflowWriter:              deps.WorkflowWriter,
		PageReader:                  deps.PageReader,
		PageWriter:                  deps.PageWriter,
		JavaActionReader:            deps.JavaActionReader,
		JavaActionWriter:            deps.JavaActionWriter,
		JavaScriptActionWriter:      deps.JavaScriptActionWriter,
		EnumerationReader:           deps.EnumerationReader,
		EnumerationWriter:           deps.EnumerationWriter,
		ConstantReader:              deps.ConstantReader,
		ConstantWriter:              deps.ConstantWriter,
		...
		MappingWriter:               deps.MapperWriter,
		UnitReader:                  deps.UnitReader,
		UnitWriter:                  deps.UnitWriter,
		...
		CacheInvalidator:            deps.CacheInvalidator,
		FolderManager:               deps.FolderManager,
		ModuleSettingsReader:        deps.ModuleSettingsReader,
		ModuleSettingsWriter:        deps.ModuleSettingsWriter,
		...
		ScriptTransactionManager:    deps.ScriptTransactionManager,
		AgentEditorOperator:         deps.AgentEditorOperator,
		Microflows:                  deps.MicroflowRepo,
		Nanoflows:                   deps.NanoflowRepo,
		...
		ScriptDepth:                 deps.ScriptDepth,
		DescribingMicroflowHasReturnValue: deps.DescribingMicroflowHasReturnValue,
