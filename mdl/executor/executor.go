...
func (c *executorCache) MicroflowsWithContainer() []MicroflowGenWithContainer { return c.microflowsWithContainerGen }
func (c *executorCache) SetMicroflowsWithContainer(v []MicroflowGenWithContainer) { c.microflowsWithContainerGen = v }
func (c *executorCache) NanoflowsWithContainer() []NanoflowGenWithContainer   { return c.nanoflowsWithContainerGen }
func (c *executorCache) SetNanoflowsWithContainer(v []NanoflowGenWithContainer) { c.nanoflowsWithContainerGen = v }
func (c *executorCache) PagesWithContainer() []ContainerWithGen[*genPg.Page]  { return c.pagesWithContainerGen }
func (c *executorCache) SetPagesWithContainer(v []ContainerWithGen[*genPg.Page]) { c.pagesWithContainerGen = v }
func (c *executorCache) LayoutsWithContainer() []ContainerWithGen[*genPg.Layout] { return c.layoutsWithContainerGen }
func (c *executorCache) SetLayoutsWithContainer(v []ContainerWithGen[*genPg.Layout]) { c.layoutsWithContainerGen = v }
func (c *executorCache) SnippetsWithContainer() []ContainerWithGen[*genPg.Snippet] { return c.snippetsWithContainerGen }
func (c *executorCache) SetSnippetsWithContainer(v []ContainerWithGen[*genPg.Snippet]) { c.snippetsWithContainerGen = v }
func (c *executorCache) WorkflowsWithContainer() []ContainerWithGen[*genWf.Workflow] { return c.workflowsWithContainerGen }
func (c *executorCache) SetWorkflowsWithContainer(v []ContainerWithGen[*genWf.Workflow]) { c.workflowsWithContainerGen = v }
func (c *executorCache) JavaActionsWithContainer() []ContainerWithGen[*genJA.JavaAction] { return c.javaActionsWithContainerGen }
func (c *executorCache) SetJavaActionsWithContainer(v []ContainerWithGen[*genJA.JavaAction]) { c.javaActionsWithContainerGen = v }
func (c *executorCache) JavaScriptActionsWithContainer() []ContainerWithGen[*genJSA.JavaScriptAction] { return c.javaScriptActionsWithContainerGen }
func (c *executorCache) SetJavaScriptActionsWithContainer(v []ContainerWithGen[*genJSA.JavaScriptAction]) { c.javaScriptActionsWithContainerGen = v }
func (c *executorCache) DomainModelsWithContainer() []DomainModelGenWithContainer { return c.domainModelsWithContainerGen }
func (c *executorCache) SetDomainModelsWithContainer(v []DomainModelGenWithContainer) { c.domainModelsWithContainerGen = v }
...
func (c *executorCache) ModuleSecurityWithContainer() []ModuleSecurityGenWithContainer { return c.moduleSecurityWithContainerGen }
func (c *executorCache) SetModuleSecurityWithContainer(v []ModuleSecurityGenWithContainer) { c.moduleSecurityWithContainerGen = v }
func (c *executorCache) DomainModelByModule() map[model.ID]*genDm.DomainModel { return c.domainModelByModule }
func (c *executorCache) SetDomainModelByModule(v map[model.ID]*genDm.DomainModel) { c.domainModelByModule = v }
