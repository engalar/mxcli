...
// setExtraStringField was the original string-only ad-hoc Property
// helper introduced in Stage 3.2.3.f. It has been superseded by
// `setRawBSONField` (Stage 3.2.3.f0), which accepts any value type
// and lives in its own file. Call sites should use setRawBSONField.
