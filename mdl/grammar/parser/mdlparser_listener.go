...
type MDLParserListener interface {
	...
	// EnterSystemMembersClause is called when entering the systemMembersClause production.
	EnterSystemMembersClause(c *SystemMembersClauseContext)

	// EnterSystemMemberName is called when entering the systemMemberName production.
	EnterSystemMemberName(c *SystemMemberNameContext)
	...
	// EnterAlterModuleJarDepStatement is called when entering the alterModuleJarDepStatement production.
	EnterAlterModuleJarDepStatement(c *AlterModuleJarDepStatementContext)

	// EnterAlterModuleJarDepAction is called when entering the alterModuleJarDepAction production.
	EnterAlterModuleJarDepAction(c *AlterModuleJarDepActionContext)

	// EnterJarDepProperty is called when entering the jarDepProperty production.
	EnterJarDepProperty(c *JarDepPropertyContext)
	...
	// EnterJavaActionSourceBlock is called when entering the javaActionSourceBlock production.
	EnterJavaActionSourceBlock(c *JavaActionSourceBlockContext)
	...
	// EnterGenerateJumpToStatement is called when entering the generateJumpToStatement production.
	EnterGenerateJumpToStatement(c *GenerateJumpToStatementContext)

	// EnterApplyJumpToStatement is called when entering the applyJumpToStatement production.
	EnterApplyJumpToStatement(c *ApplyJumpToStatementContext)
	...
	// EnterGrantMember is called when entering the grantMember production.
	EnterGrantMember(c *GrantMemberContext)
	...
	// EnterWorkflowCompletionMethod is called when entering the workflowCompletionMethod production.
	EnterWorkflowCompletionMethod(c *WorkflowCompletionMethodContext)
	...
	// EnterLanguageOptions is called when entering the languageOptions production.
	EnterLanguageOptions(c *LanguageOptionsContext)

	// EnterLanguageOption is called when entering the languageOption production.
	EnterLanguageOption(c *LanguageOptionContext)
	...
	// EnterTranslateDocType is called when entering the translateDocType production.
	EnterTranslateDocType(c *TranslateDocTypeContext)

	// EnterTranslateSetOp is called when entering the translateSetOp production.
	EnterTranslateSetOp(c *TranslateSetOpContext)

	// EnterTranslatePath is called when entering the translatePath production.
	EnterTranslatePath(c *TranslatePathContext)

	// EnterTranslateMicroflowStatement is called when entering the translateMicroflowStatement production.
	EnterTranslateMicroflowStatement(c *TranslateMicroflowStatementContext)

	// EnterTranslateMicroflowSetOp is called when entering the translateMicroflowSetOp production.
	EnterTranslateMicroflowSetOp(c *TranslateMicroflowSetOpContext)
	...
	// ExitSystemMembersClause is called when exiting the systemMembersClause production.
	ExitSystemMembersClause(c *SystemMembersClauseContext)

	// ExitSystemMemberName is called when exiting the systemMemberName production.
	ExitSystemMemberName(c *SystemMemberNameContext)
	...
	// ExitAlterModuleJarDepStatement is called when exiting the alterModuleJarDepStatement production.
	ExitAlterModuleJarDepStatement(c *AlterModuleJarDepStatementContext)

	// ExitAlterModuleJarDepAction is called when exiting the alterModuleJarDepAction production.
	ExitAlterModuleJarDepAction(c *AlterModuleJarDepActionContext)

	// ExitJarDepProperty is called when exiting the jarDepProperty production.
	ExitJarDepProperty(c *JarDepPropertyContext)
	...
	// ExitJavaActionSourceBlock is called when exiting the javaActionSourceBlock production.
	ExitJavaActionSourceBlock(c *JavaActionSourceBlockContext)
	...
	// ExitGenerateJumpToStatement is called when exiting the generateJumpToStatement production.
	ExitGenerateJumpToStatement(c *GenerateJumpToStatementContext)

	// ExitApplyJumpToStatement is called when exiting the applyJumpToStatement production.
	ExitApplyJumpToStatement(c *ApplyJumpToStatementContext)
	...
	// ExitGrantMember is called when exiting the grantMember production.
	ExitGrantMember(c *GrantMemberContext)
	...
	// ExitWorkflowCompletionMethod is called when exiting the workflowCompletionMethod production.
	ExitWorkflowCompletionMethod(c *WorkflowCompletionMethodContext)
	...
	// ExitLanguageOptions is called when exiting the languageOptions production.
	ExitLanguageOptions(c *LanguageOptionsContext)

	// ExitLanguageOption is called when exiting the languageOption production.
	ExitLanguageOption(c *LanguageOptionContext)
	...
	// ExitTranslateDocType is called when exiting the translateDocType production.
	ExitTranslateDocType(c *TranslateDocTypeContext)

	// ExitTranslateSetOp is called when exiting the translateSetOp production.
	ExitTranslateSetOp(c *TranslateSetOpContext)

	// ExitTranslatePath is called when exiting the translatePath production.
	ExitTranslatePath(c *TranslatePathContext)

	// ExitTranslateMicroflowStatement is called when exiting the translateMicroflowStatement production.
	ExitTranslateMicroflowStatement(c *TranslateMicroflowStatementContext)

	// ExitTranslateMicroflowSetOp is called when exiting the translateMicroflowSetOp production.
	ExitTranslateMicroflowSetOp(c *TranslateMicroflowSetOpContext)
